      ...
      >
        ...
        />
            ...
            <p className="font-light text-sm text-gray-500 mb-3">
              Easily track and manage your tasks, so nothing falls through the
              cracks.
            </p>
          </div>
          <div className="p-8">
          <div
      className="bg-indigo-100 rounded-full w-16 h-16 flex justify-center items-center text-green-500 shadow-2xl"
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        className="h-8 w-8"
      ...
      >
        ...
        />
            ...
            <p className="font-light text-sm text-gray-500 mb-3">
              Collaborate with your team on tasks and projects for better
              efficiency.
            </p>
          </div>
          <div className="p-8">
            <div
      className="bg-indigo-100 rounded-full w-16 h-16 flex justify-center items-center text-red-500 shadow-2xl"
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        className="h-8 w-8"
      ...
      >
        ...
        />
            ...
            <p className="font-light text-sm text-gray-500 mb-3">
              Prioritize your tasks to focus on what matters most and increase
              productivity.
            </p>
          </div>
        </div>
